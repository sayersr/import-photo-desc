            ...
            for layer in layers:
                ...
                if set(fields).issubset(self.drawSelf.fields):
                    ...
                    if selected_features != []:
                        ...
                        imagedescription = str(feature.attributes()[feature.fieldNameIndex('Description')])
                        if str(feature.attributes()[feature.fieldNameIndex('Description')])=='':
                            imagedescription = "None"
                            self.photosDLG.infoPhoto3.setText("Description: "+imagedescription)
                        else:
                            self.photosDLG.infoPhoto3.setText("Description: "+imagedescription)
